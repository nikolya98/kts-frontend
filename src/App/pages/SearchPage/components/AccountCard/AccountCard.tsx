...
const AccountCard: React.FC<AccountCardProps> = ({ account }): JSX.Element => {
  return (
    <article className={accountCardStyle.card}>
      <div className={accountCardStyle.avatar}>
        <Avatar
      ...
      <div className={accountCardStyle.header}>
        <Link
      ...
      <dl className={accountCardStyle.stats}>
        ...
        <dd className={accountCardStyle["stat-value"]}>{account.followers}</dd>
        <dt className={accountCardStyle["stat-tltle"]}>Following</dt>
        <dd className={accountCardStyle["stat-value"]}>{account.following}</dd>
      </dl>
      <ul className={accountCardStyle.socials}>
        ...
        <li>
          ...
          {(account.blog && (
            <a className={accountCardStyle["social-link"]} href={account.blog}>
              {account.blog}
            </a>
          )) ||
            "Not available"}
        ...
        <li>
          ...
          {(account.email && (
            <a className={accountCardStyle["social-link"]} href={account.email}>
              {account.email}
            </a>
          )) ||
            "Not available"}
